...
import { Input, Button, InputGroup, Combobox, Textearea } from '../../components'
...
const BannerEdit = () => {
    ...
    useEffect(() => {
        if(categoryBannerDetail){
            setFormData({
                name: categoryBannerDetail?.name || '',
                thumbnail: categoryBannerDetail?.thumbnail || '',
                thumbnail_1: categoryBannerDetail?.thumbnail_1 || '',
                content: categoryBannerDetail?.content || '',
                status: categoryBannerDetail?.status || '',
                discount: categoryBannerDetail?.discount || '',
            })
        }
    ...
    const handleChange = (e, selected) => {
        setFormData({
            ...formData,
            [e.target.name]: selected ? selected.value || selected.id : e.target.value
        })
    }
    ...
    useEffect(() => {
        if(message === "Cập nhật banner thành công!"){
