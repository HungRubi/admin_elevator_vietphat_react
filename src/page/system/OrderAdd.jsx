        ...
        <div className="full pt-5">
            ...
            <form className="w-full px-[30px] bg-white mt-8" method="POST">
                ...
                <div className="w-full flex border-b-custom py-10">
                    ...
                    <div className="flex-1">
                        <SelectiObject label={"Fullname"} name={"name"} data={orderUser}/>
                        ...
                        icon={<FaMapMarkerAlt className="text-[17px] text-gray-500"/>} name="price"/>
                    </div>
                </div>
                <div className="w-full flex border-b-custom py-10">
                    <div className="w-2/6">
                    ...
                    <div className="flex-1">
                        <Combobox data={payment} label={"Unit"} name={"unit"}/>
                        <Combobox data={status} label={"Category"} name={"category"}/>
                    </div>
                </div>
