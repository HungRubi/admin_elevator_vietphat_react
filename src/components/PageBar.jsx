...
const PageBar = ({ currentPage, totalPage, onPageChange }) => {
    return (
        <div className="flex items-center justify-center my-10">
            <Button className="bg-transparent !border-none" disabled={currentPage === 1}>
                <div
            ...
            {Array.from({ length: totalPage }, (_, i) => i + 1).map((page) => (
                <Button key={page} className="bg-transparent !border-none">
                    <div
            ...
            <Button className="bg-transparent !border-none" disabled={currentPage === totalPage}>
                <div
                    onClick={() => onPageChange(currentPage + 1)}
