...
const InputGroup = ({label, icon, name, value, pattern, type, placeholder, helper, onChange, max}) => {
    return (
        <div className="mt-5">
            ...
            <div className="relative">
                ...
                <input type={type} id="zip-input" aria-describedby="helper-text-explanation" name={name} value={value} min={type === "number" ? "0" : ""} max={max}
                ...
                placeholder={placeholder} pattern={pattern} onChange={onChange} required />
            </div>
